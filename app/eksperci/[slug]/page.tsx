...
export default async function ExpertProfile({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="shell narrow content-section">
    ...
    <section><h2>Status recenzji treści</h2><p>Potwierdzenie tożsamości lekarza nie oznacza, że zweryfikował artykuły w tym serwisie. Żadna treść nie jest przypisana mu jako recenzentowi bez udokumentowanego przeglądu konkretnej strony.</p></section>
